package org.polo.common.logger;/*
...
import org.polo.common.utils.SystemUtil;
...
class DirectJDKLog implements Log {
    ...
    protected static void init(Properties properties) {
        String logPath = properties.getProperty("log.path", SystemUtil.getAgentPath() + "/agnet-logs/");
